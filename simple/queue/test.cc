...
void test_customize2(){
    lockfree::lfree_queue<std::string> q;
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize3(){
    lockfree::lfree_queue<std::vector<int>> q;
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize4(){
    lockfree::lfree_queue<NoDefault> q;
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize5(){
    lockfree::lfree_queue<BigObject> q(lockfree::K01);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_shared(){
    lockfree::lfree_queue<std::shared_ptr<int>> q;
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_unique(){
    lockfree::lfree_queue<std::unique_ptr<int>> q;
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
