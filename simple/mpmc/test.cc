...
void test_customize1(){
    lockfree::lfree_queue_mpmc<temp1> q(2,2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize2(){
    lockfree::lfree_queue_mpmc<std::string> q(2,2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize3(){
    lockfree::lfree_queue_mpmc<std::vector<int>> q(2,2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize4(){
    lockfree::lfree_queue_mpmc<NoDefault> q(2,2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize5(){
    lockfree::lfree_queue_mpmc<BigObject> q(2,2,lockfree::K01);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_shared(){
    lockfree::lfree_queue_mpmc<std::shared_ptr<int>> q(2,2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_unique(){
    lockfree::lfree_queue_mpmc<std::unique_ptr<int>> q(2,2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
