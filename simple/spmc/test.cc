...
void test_internal1(){
    lockfree::lfree_queue_spmc<int> q(2);
    size_t count_p = 0;
    std::atomic<size_t> count_c { 0 };
    std::thread producer([&q,&count_p](){
...
void test_internal2(){
    ...
    std::thread consumer2(comuser_back);
...
void test_customize1(){
    lockfree::lfree_queue_spmc<temp1> q(2);
    size_t count_p = 0;
    std::atomic<size_t> count_c { 0 };
    std::thread producer([&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize2(){
    lockfree::lfree_queue_spmc<std::string> q(2);
    size_t count_p = 0;
    std::atomic<size_t> count_c { 0 };
    std::thread producer([&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize3(){
    lockfree::lfree_queue_spmc<std::vector<int>> q(2);
    size_t count_p = 0;
    std::atomic<size_t> count_c { 0 };
    std::thread producer([&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize4(){
    lockfree::lfree_queue_spmc<NoDefault> q(2);
    size_t count_p = 0;
    std::atomic<size_t> count_c { 0 };
    std::thread producer([&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize5(){
    lockfree::lfree_queue_spmc<BigObject> q(2,lockfree::queue_size::K01);
    size_t count_p = 0;
    std::atomic<size_t> count_c { 0 };
    std::thread producer([&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_shared(){
    lockfree::lfree_queue_spmc<std::shared_ptr<int>> q(2);
    size_t count_p = 0;
    std::atomic<size_t> count_c { 0 };
    std::thread producer([&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_unique(){
    lockfree::lfree_queue_spmc<std::unique_ptr<int>> q(2);
    size_t count_p = 0;
    std::atomic<size_t> count_c { 0 };
    std::thread producer([&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
