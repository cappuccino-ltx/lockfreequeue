...
void test_internal1(){
    lockfree::concurrent_queue<int> q(2);
...
void test_customize1(){
    lockfree::concurrent_queue<temp1> q(2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize2(){
    lockfree::concurrent_queue<std::string> q(2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize3(){
    lockfree::concurrent_queue<std::vector<int>> q(2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize4(){
    lockfree::concurrent_queue<NoDefault> q(2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_customize5(){
    lockfree::concurrent_queue<BigObject> q(2,lockfree::K01);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_shared(){
    lockfree::concurrent_queue<std::shared_ptr<int>> q(2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
...
void test_unique(){
    lockfree::concurrent_queue<std::unique_ptr<int>> q(2);
    std::atomic<size_t> count_p { 0 };
    std::atomic<size_t> count_c { 0 };
    auto producer_back = [&q, &count_p](){
        for(int i = 1; i <= 10000; i++) {
